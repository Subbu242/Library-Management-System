	...
	<div class="row" style="width: 69%;">
		<div class="col-md-8" id="main_content">
			...
			<form action="" method="post" id = "form_login">
				...
				<div class="form-group">
					<input placeholder="Enter your password" type="password" style = "width:75% !important" name="password" class="form-control" required>
				</div>
				
				<button type="submit" name="login" class="btn btn-primary">Login</button></center>	
