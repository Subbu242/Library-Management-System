			...
			<div class="col-md-4">
				<form action="" method="post">
					...
					<div class="form-group">
						...
						<input type="text" name="due_date" class="form-control" value="<?php echo date_format(date_add(date_create(date("Y-m-d")),date_interval_create_from_date_string("15 days")),"Y-m-d");?>" disabled>
					</div>
...
<?php
	if(isset($_POST['issue_book']))
	{
		...
		// $connection = mysqli_connect("nxn9086.uta.cloud","nxn9086_advse","Lms@advse");
		// $db = mysqli_select_db($connection,"nxn9086_LMS");
		$query1 = "select id from users where name='$_POST[student_id]'";
		$query_run1 = mysqli_query($connection,$query1);
		$row1= mysqli_fetch_assoc($query_run1);
		$studentID=$row1['id'];
		$query = "insert into issued_books values(null,'$_POST[book_name]','$_POST[book_author]',$studentID,1,'$_POST[issue_date]','$_POST[due_date]')";
		$query_run = mysqli_query($connection,$query);
		?>
		<script>
