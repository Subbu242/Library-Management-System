<?php
	...
	$book_no = "";
	$student_name = "";
	$query = "select issued_books.book_name,issued_books.book_author,users.name from issued_books,users where issued_books.status = 1 and users.id = $_GET[uid] and issued_books.student_id = users.id ";
?>
<!DOCTYPE html>
<html>
<head>
